...
> **Suggested image:** A comparison of pre-2000s manufacturer-specific tyre
> warning symbols against the standardised ISO 2575 tyre-pressure pictogram
> **Notice:** how many distinct shapes were competing to mean the same
> single fact — low tyre pressure — before convergence
> **Annotation:** an arrow from each pre-2000s symbol to the one ISO
> pictogram they were all eventually replaced by
> **Caption:** "Before ISO 2575, 'check your tyre pressure' had no fixed
> shape — after it, it had exactly one."
> **Alt text:** "A grid of six differently-shaped pre-2000s dashboard
> warning icons for low tyre pressure, arranged above a single converged
> ISO 2575 pictogram of a tyre cross-section with an exclamation mark,
> with arrows showing all six collapsing into the one standard symbol."
...
> **Suggested image:** The ISO 2575 TPMS pictogram as it appears lit, amber,
> on a current-model instrument cluster
> **Notice:** how small and simple the final, converged symbol actually is
> compared to the variety that preceded it
> **Annotation:** a callout pointing to the exclamation mark specifically,
> noting it is the only element that changes colour (amber vs red) across
> severity
> **Caption:** "The pictogram that won: a tyre cross-section and an
> exclamation mark, unchanged across manufacturers since the mid-2000s."
> **Alt text:** "A close-up photograph of an illuminated amber dashboard
> telltale showing the ISO 2575 tyre-pressure pictogram, a simplified
> tyre cross-section with an exclamation mark centred inside it."
...
> **Suggested image:** A page from a TREAD Act–era (early-to-mid 2000s) US
> owner's manual showing a first-generation mandated TPMS telltale
> alongside its written explanation
> **Notice:** how much explanatory text the manual still needed even though
> the icon itself was already meant to be self-explanatory
> **Annotation:** a bracket around the paragraph of text explaining the
> icon, labelled "this paragraph is what the icon is supposed to replace,
> eventually"
> **Caption:** "Early mandated TPMS icons still needed a manual paragraph
> to back them up — the icon hadn't been learned yet."
> **Alt text:** "A scanned page from an early-2000s American car owner's
> manual, showing a small illustration of an amber tyre-pressure warning
> icon next to a paragraph of explanatory text describing what the icon
> means and what action the driver should take."
