...
> **Suggested image:** A modern instrument cluster (e.g. a current Toyota
> RAV4 or Volvo XC60 cluster) showing red, amber and green/blue telltales lit
> simultaneously, ideally from a self-test/startup sequence
> **Notice:** How far apart the three colours sit from each other in the
> layout, and whether any two telltales of different tiers are placed close
> enough together to be mistaken for each other under a glance
> **Annotation:** Arrows from each lit telltale to a label reading "tier 1 —
> immediate", "tier 2 — advisory", or "tier 3 — informational"
> **Caption:** "Three colours, three tiers, one glance: the cluster expects
> urgency to be sorted before any icon is read."
> **Alt text:** "A car instrument cluster with several warning telltales
> illuminated at once in red, amber and green, arranged in a horizontal band
...
> **Suggested image:** A side-by-side of a Tesla Model 3 instrument display
> showing Autopilot engaged (blue/white status) next to a Volvo XC60 cluster
> showing City Safety engaged (green status)
> **Notice:** Both are the same urgency tier — informational/confirmation —
> rendered in two different colours
> **Annotation:** A bracket under each image labelled "informational tier:
> blue" and "informational tier: green"
> **Caption:** "Same tier, different colour: the ISO standard permits both,
> but a driver switching cars has to relearn which one means 'no action
> needed'."
> **Alt text:** "Two car instrument displays side by side, one showing a
> blue-white driver-assist status icon, the other showing a green driver-
> assist status icon, both indicating an active safety system."
...
> **Suggested image:** A photographed instrument cluster (any modern sedan
> with a visible telltale bank) shown twice — once as photographed, once
> processed through a deuteranopia colour-blindness simulation filter
> **Notice:** Which specific telltales that were clearly different colours in
> the original become the same muddy shade in the simulated version
> **Annotation:** Circles around the two or three telltales that become
> hardest to tell apart, with a line connecting them to the words "same
> colour now"
> **Caption:** "Run through a red-green colour-blindness simulation, a brake
> warning and a system-active light can become the same shade."
> **Alt text:** "Two versions of the same car instrument cluster side by
> side: the left in normal colour showing distinct red, amber and green
> telltales, the right processed through a colour-blindness simulation
> showing the same telltales all rendered in similar muted yellow-brown
> tones."
