...
> **Suggested image:** A driver-assistance warning display showing an
> imminent-braking alert, e.g. from a Toyota Pre-Collision System or
> comparable AEB-equipped vehicle, captured at the moment the warning and the
> braking visibly overlap
> **Notice:** whether the warning graphic and the deceleration appear to
> start at the same instant, or whether there's a visible gap between them
> **Annotation:** a timestamp overlay on the warning icon and a second
> timestamp on the first visible sign of braking, showing the gap (or lack
> of one) between them
> **Caption:** "The warning and the braking can arrive close enough together
> that the driver has no time to act on the warning before the car already
> has."
> **Alt text:** "A dashboard driver-information display showing a red
> forward-collision warning icon of a car with radiating lines above an
> exclamation mark, illuminated at the same moment the vehicle's automatic
> emergency braking has visibly engaged."
...
> **Suggested image:** A first-generation Volvo XC60 (2008) instrument
> cluster or manufacturer press photograph showing the City Safety forward
> sensor housing near the top of the windscreen, alongside any accompanying
> in-cluster warning display
> **Notice:** how little visual emphasis the original marketing and interface
> placed on a driver-facing warning display, compared to how much emphasis
> was placed on the autonomous braking action itself
> **Annotation:** a callout on the sensor housing labelled "detects," and a
> separate callout on the brake pedal labelled "acts — the warning, if any,
> is secondary"
> **Caption:** "City Safety was designed and marketed around what the car
> would do, not around what the driver would be told."
> **Alt text:** "A press photograph of a first-generation Volvo XC60 dashboard
> and windscreen, with the City Safety forward-facing sensor visible near the
> top of the windscreen and the instrument cluster showing no prominent
> dedicated warning graphic."
...
> **Suggested image:** A small comparison grid of dashboard telltales for
> forward-collision warning, lane-keep-assist correction, and
> adaptive-cruise-control gap alert, drawn from two or three different
> manufacturers' owner's manuals
> **Notice:** which of the three icons visually implies an action the car is
> taking versus a condition the car is merely observing
> **Annotation:** a two-colour underline beneath each icon — one colour for
> "reports," one for "narrates" — showing that the icon shapes alone don't
> reliably signal which category an alert belongs to
> **Caption:** "Nothing about an icon's shape tells you, on its own, whether
> the car is reporting or about to act — that has to come from context,
> timing, or a deliberately different treatment."
> **Alt text:** "A grid of dashboard telltale icons for forward-collision
> warning, lane-keep-assist, and adaptive-cruise-control gap alerts sourced
> from several manufacturers' owner's manuals, each underlined in one of two
> colours to mark whether it reports a state or narrates a decision the car
> is making."
