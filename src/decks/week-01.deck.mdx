...
> **Suggested image:** A conventional analogue fuel gauge with an amber
> low-fuel icon illuminated beside the needle — e.g. a Toyota Corolla or
> Honda Civic instrument cluster
> **Notice:** the needle position relative to the low-fuel icon's threshold
> mark
> **Annotation:** an arrow from the icon to the point on the dial where it
> switches on, showing the two instruments share one measurement but report
> it differently
> **Caption:** "One measurement, two channels: a needle for trend, a light
> for threshold."
> **Alt text:** "Close-up of a car instrument cluster showing an analogue
> fuel gauge needle sitting just above empty, with an amber low-fuel warning
> icon illuminated to its left."
...
> **Suggested image:** A modern reconfigurable digital instrument cluster
> (e.g. Audi virtual cockpit or BMW Live Cockpit) shown in two display
> modes — navigation-priority and gauge-priority
> **Notice:** how the same physical screen re-labels the same space
> depending on what the driver selected or what the car prioritised
> **Annotation:** a bracket connecting the two screenshots labelled "same
> hardware, different grammar"
> **Caption:** "The instrument cluster as software: the same 12 inches of
> glass can be a speedometer or a map."
> **Alt text:** "Two side-by-side photographs of the same digital instrument
> cluster, one showing a large central speedometer dial, the other showing
> the same space replaced by a full-width navigation map."
...
> **Suggested image:** Jaguar E-Type Series 1 dashboard, driver's-eye view,
> showing the twin speedometer/tachometer dials and toggle switches
> **Notice:** the total absence of any warning-light cluster — no dedicated
> telltale panel anywhere on the dash
> **Annotation:** a circle around where a modern car would place its
> telltale array, labelled "nothing here in 1961"
> **Caption:** "No idiot lights: every fault reads as a needle in the wrong
> place."
> **Alt text:** "Photograph of a Jaguar E-Type Series 1 dashboard from the
> driver's seat, showing two large matching circular gauges for speed and
> engine revolutions, several smaller analogue gauges, and toggle switches,
> with no illuminated warning lights visible."
