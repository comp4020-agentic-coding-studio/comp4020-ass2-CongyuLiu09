...
> **Suggested image:** A 1930s-era dashboard, e.g. a Ford Model A or
> contemporary sedan instrument panel — Wikimedia Commons or a marque
> heritage archive.
> **Notice:** how few instruments there are — often just a speedometer and an
> ammeter, no tachometer, no fuel gauge in some models.
> **Annotation:** an arrow to the single large dial, labelled "the only
> continuous number this driver gets."
> **Caption:** "Before the dashboard had a vocabulary, it had one word."
> **Alt text:** "A monochrome photograph of a 1930s car dashboard showing a
> single large speedometer dial flanked by two small unlabelled gauges, set
> into a plain metal panel."
...
> **Suggested image:** A clean, well-lit photograph of a single analogue
> tachometer face — any 1990s–2000s example with a visible redline, e.g. a
> BMW E36 3 Series cluster — Wikimedia Commons.
> **Notice:** where the needle sits at a typical cruising rpm relative to the
> twelve o'clock position, and how far the red zone is printed from that rest
> point.
> **Annotation:** two arrows — one at the printed redline, one at the "normal
> cruise" position the driver has to have memorised, since nothing on the
> face marks it.
> **Caption:** "The dial prints the danger zone. It never prints the safe
> one."
> **Alt text:** "A close-up photograph of a car tachometer face showing
> numbered markings from 0 to 8 with a red arc between 6 and 8, and a needle
> resting near the 2 mark."
...
> **Suggested image:** Toyota Camry or Honda Accord instrument cluster,
> driver's-eye view, base or mid trim — Wikimedia Commons or manufacturer
> press media.
> **Notice:** the speedometer's size and central position relative to a
> smaller tachometer, often to its left.
> **Annotation:** an arrow at the speedometer's numeral range for the posted
> limit, contrasted with a second arrow at the tachometer's much smaller
> redline marking.
> **Caption:** "Same grammar, opposite priority — the biggest dial is the one
> with a legal number attached."
> **Alt text:** "A photograph of a mainstream sedan instrument cluster with a
> large central speedometer numbered to around 260 km/h and a smaller
> tachometer to its left numbered to 7."
