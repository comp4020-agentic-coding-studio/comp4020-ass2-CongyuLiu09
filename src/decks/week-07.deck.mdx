...
> **Suggested image:** A multi-information display showing the plain-language
> message "Low tyre pressure — check tyres," photographed next to an older
> instrument cluster showing only a lit tyre-pressure icon and the acronym
> `TPMS`
> **Notice:** How many words it takes the modern display to say what the
> older cluster compresses into one small icon and three letters
> **Annotation:** An arrow from the acronym `TPMS` to a note reading "meaning
> lives in the owner's manual, not on the display"
> **Caption:** "Same fault, two eras of dashboard language: a code to look up,
> or a sentence to read."
> **Alt text:** "Side-by-side photograph comparing a modern multi-information
> display reading 'Low tyre pressure — check tyres' with an older instrument
> cluster showing only a lit tyre icon and the letters TPMS."
...
> **Suggested image:** A manufacturer's owner's manual "warning messages"
> table, showing the same tyre-pressure message translated across three or
> four languages side by side
> **Notice:** How differently long the "same" sentence is once translated —
> some languages need noticeably more words to say the identical thing
> **Annotation:** A bracket under the shortest and longest translated
> versions, labelled "same meaning, different reading-time cost per market"
> **Caption:** "The pictogram above this table didn't need this page. The
> sentence did."
> **Alt text:** "A photograph of an owner's manual page listing a
> tyre-pressure warning message translated into several languages in
> parallel columns, illustrating varying sentence length for the same
> meaning."
