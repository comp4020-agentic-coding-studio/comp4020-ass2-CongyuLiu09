...
> **Suggested image:** A lane-departure-warning icon or on-screen alert
> triggering on a stretch of road with faded, patchy, or unusually marked
> lane lines
> **Notice:** how ordinary and unremarkable the road looks — no obstruction,
> no weather event, just worn paint
> **Annotation:** a callout circling the specific faded section of lane
> marking the sensor most likely misread as a lane edge
> **Caption:** "The road didn't do anything unusual. That's exactly why this
> kind of false alarm is so hard to design out."
> **Alt text:** "A driver's-eye dashboard view showing an illuminated
> lane-departure warning icon overlaid on a windscreen view of a road with
> faded, inconsistent white lane markings and no other visible hazard."
...
> **Suggested image:** A photograph of a 1970s–80s commercial airliner
> cockpit alarm panel, showing multiple physical annunciator lights and a
> master caution indicator
> **Notice:** how many distinct alarm sources are crowded into one panel,
> all competing for the same pilot's attention
> **Annotation:** a callout on the master caution light specifically,
> labelled "the light every other light on this panel eventually routes
> through"
> **Caption:** "Aviation studied alarm fatigue here first — long before a
> lane-departure chime existed to inherit the same problem."
> **Alt text:** "A photograph of a vintage commercial airliner cockpit
> instrument panel showing rows of amber and red annunciator warning
> lights alongside a prominent master caution indicator light."
...
> **Suggested image:** A screenshot or photograph of an owner-forum post or
> consumer-complaint filing describing a driver disabling a lane-keeping or
> forward-collision feature
> **Notice:** the specific, repeatable condition the driver names as the
> trigger, rather than a one-off event
> **Annotation:** a highlight on the phrase describing how many times the
> false alarm occurred before the driver disabled the feature
> **Caption:** "The complaint is rarely 'it was wrong once' — it's almost
> always 'it was wrong enough times that I stopped trusting it.'"
> **Alt text:** "A screenshot of an online consumer complaint or forum post
> in which a car owner describes repeated false lane-departure or
> collision warnings on a specific road condition, and states that they
> disabled the feature as a result."
