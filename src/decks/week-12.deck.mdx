...
> **Suggested image:** A Rivian R1T or R1S driver display showing its
> driver-assistance status indicators, ideally from two different software
> versions if a paired screenshot can be found
> **Notice:** any difference in naming, icon shape, or layout for what is
> functionally the same underlying feature across versions
> **Annotation:** a line connecting the two versions' labels for the same
> feature, marked "same capability, relabelled between builds"
> **Caption:** "The feature didn't change. The word for it did."
> **Alt text:** "A Rivian driver display showing driver-assistance status
> icons and labels, illustrating how a feature's name and icon can be
> altered by a firmware update rather than a hardware change."
...
> **Suggested image:** A Tesla Model 3/Y instrument display, or a
> comparable software-defined-vehicle cluster, showing how much of its
> "instrument panel" is actually just software rendered on a general-purpose
> screen
> **Notice:** the absence of any dedicated physical gauge housing behind the
> glass — every element on screen could, in principle, be relocated or
> redesigned by the next update
> **Annotation:** an arrow from the display to a note reading "this whole
> layout is a build number, not a fixed instrument"
> **Caption:** "The instrument cluster as a version number: what you're
> reading may not be what next month's owner reads."
> **Alt text:** "Photograph of a software-defined-vehicle driver display
> showing speed, range and status icons rendered on a single digital
> screen, with no separate physical gauge cluster visible behind it."
...
> **Suggested image:** A manufacturer's over-the-air release-notes page
> (Tesla or Rivian) listing a change to a driver-facing alert or warning
> behaviour
> **Notice:** how briefly, and how technically, a change to something a
> driver relies on daily is actually described
> **Annotation:** a bracket around a one-line changelog entry, labelled
> "this sentence is the driver's only notice that their dashboard's
> vocabulary just moved"
> **Caption:** "The whole disclosure, for a change to a language you
> already trusted."
> **Alt text:** "A screenshot of an over-the-air software release-notes
> page listing a brief technical description of a change to a
> driver-assistance alert's sensitivity, with no further explanation
